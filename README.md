...
The block uses a Void Motor-inspired model and owner avatar slot. Configure the per-RPM charge, maximum stress at 256 RPM, charge interval, and Q-shop currency id in `config/currency_motor-common.toml`.
